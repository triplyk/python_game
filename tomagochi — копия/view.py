...
class Actor(pygame.sprite.Sprite):
    ...
    def __init__(self, pos_x, pos_y):
        ...
        self.hunger = random.randint(self.boredom_threshold,self.max_char_value)
        self.tiredness = random.randint(self.boredom_threshold,self.max_char_value)
...
class ProgressBar():
    def __init__(self, width, height, x_pas, y_pas, max_val, current_percent = 0):
        self.width = width
        self.height = height
...
class Cursor(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite. __init__(self)
        self.image = pygame.image.load ("sprites/kursor.png")
        self.rect = self.image.get_rect()
    def update(self):
